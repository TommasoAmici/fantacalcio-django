    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bonus",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="main.Bonus"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logo",
                    models.ImageField(
                        blank=True, null=True, upload_to="competition_logos/"
                    ),
                ),
                ...
                (
                    "bonus_values",
                    models.ManyToManyField(
                        blank=True, through="main.BonusValue", to="main.Bonus"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "competitions",
                    models.ManyToManyField(blank=True, to="main.Competition"),
                ),
                (
                    "creator",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "roster",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="main.Roster"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "roles",
                    models.ManyToManyField(
                        blank=True, related_name="roles_of", to="main.Role"
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            name="competition",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="main.Competition"
            ),
        ),
    ]
